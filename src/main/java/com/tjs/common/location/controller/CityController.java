 ...
 *
 */
public interface CityController extends BaseController<CityView>{
	...
	@ResponseBody
	@AccessLog
	Response dropdown(@RequestParam(value="stateId",required=true) Long stateId) throws EndlosException;
}